...
D6 = [
    ...
    2 / 36,
    1 / 36,
]  # Probabilities of sums 2...12 on two 6-sided dices
D4 = [
    1 / 16,
    2 / 16,
    3 / 16,
    ...
    2 / 16,
    1 / 16,
]  # Probabilities of sums 2...8 on two 4-sided dices
...
def problem84(dc, dpt):
    ...
    def play(
        box, cp, st, cdpt, cst
    ):  # box - index of box on which player landed, cp - current probability, st - starting call, cdpt - current depth, cst - consecutive two - sums
        nonlocal B
