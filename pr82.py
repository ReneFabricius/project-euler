    ...
    for line in f:
        ...
        for x in range(len(cL)):
            M[y][x] = [
                ...
                False,
                0,
            ]  # hodnota policka, najkratsia cesta do neho, zafixovany, smer prichodu: 0 - zaciatok, 1 - zlava, 2 - zhora, 3 - zdola
        y += 1
    f.close()
    return M
        ...
        while True:
            ...
            if not M[mdpyx[0]][mdpyx[1] + 1][2]:
                if (
                    ...
                    or M[mdpyx[0]][mdpyx[1] + 1][1]
                    > M[mdpyx[0]][mdpyx[1] + 1][0] + mdp[1]
                ):
            ...
            if mdpyx[0] < h - 1 and not M[mdpyx[0] + 1][mdpyx[1]][2]:
                if (
                    ...
                    or M[mdpyx[0] + 1][mdpyx[1]][1]
                    > M[mdpyx[0] + 1][mdpyx[1]][0] + mdp[1]
                ):
