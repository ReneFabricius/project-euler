        ...
        for p2i in range(len(Pn[1])):
            ...
            for p1i in range(len(Pn[0])):
                for p1j in range(p1i + 1, len(Pn[0])):
                    for p1k in range(p1j + 1, len(Pn[0])):
                        if isPandigList(
                            [Pn[3][p4i], Pn[1][p2i], Pn[0][p1i], Pn[0][p1j], Pn[0][p1k]]
                        ):  # 4, 2, 1, 1, 1
                            c += 1
        ...
        for p3j in range(p3i + 1, len(Pn[2])):
            ...
            for p1i in range(len(Pn[0])):
                for p1j in range(p1i + 1, len(Pn[0])):
                    for p1k in range(p1j + 1, len(Pn[0])):
                        if isPandigList(
                            [Pn[2][p3i], Pn[2][p3j], Pn[0][p1i], Pn[0][p1j], Pn[0][p1k]]
                        ):  # 3, 3, 1, 1, 1
                            c += 1
        ...
        for p2i in range(len(Pn[1])):
            for p2j in range(p2i + 1, len(Pn[1])):
                for p2k in range(p2j + 1, len(Pn[1])):
                    if isPandigList(
                        [Pn[2][p3i], Pn[1][p2i], Pn[1][p2j], Pn[1][p2k]]
                    ):  # 3, 2, 2, 2
                        c += 1
                ...
                for p1i in range(len(Pn[0])):
                    for p1j in range(p1i + 1, len(Pn[0])):
                        if isPandigList(
                            [Pn[2][p3i], Pn[1][p2i], Pn[1][p2j], Pn[0][p1i], Pn[0][p1j]]
                        ):  # 3, 2, 2, 1, 1
                            c += 1
        ...
        for p2j in range(p2i + 1, len(Pn[1])):
            for p2k in range(p2j + 1, len(Pn[1])):
                for p2l in range(p2k + 1, len(Pn[1])):
                    for p1 in Pn[0]:
                        if isPandigList(
                            [Pn[1][p2i], Pn[1][p2j], Pn[1][p2k], Pn[1][p2l], p1]
                        ):  # 2, 2, 2, 2, 1
                            c += 1
