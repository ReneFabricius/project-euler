    ...
    for line in f:
        ...
        for x in range(len(cL)):
            M[y][x] = [
                ...
                False,
                0,
            ]  # hodnota policka, najkratsia cesta do neho, zafixovany, smer prichodu: 0 - zaciatok, 1 - zlava, 2 - zhora
        y += 1
    f.close()
    return M
...
def findShortstPath():
    ...
    while True:
        ...
        if mdpyx[0] < h - 1 and not M[mdpyx[0] + 1][mdpyx[1]][2]:
            if (
                M[mdpyx[0] + 1][mdpyx[1]][1] < 0
                or M[mdpyx[0] + 1][mdpyx[1]][1] > M[mdpyx[0] + 1][mdpyx[1]][0] + mdp[1]
            ):
        ...
        if mdpyx[1] < w - 1 and not M[mdpyx[0]][mdpyx[1] + 1][2]:
            if (
                M[mdpyx[0]][mdpyx[1] + 1][1] < 0
                or M[mdpyx[0]][mdpyx[1] + 1][1] > M[mdpyx[0]][mdpyx[1] + 1][0] + mdp[1]
            ):
    ...
    while pp[5] != 0:
        if pp[5] == 1:
            pp = [pp[0], pp[1] - 1] + M[pp[0]][pp[1] - 1]
        else:
            pp = [pp[0] - 1, pp[1]] + M[pp[0] - 1][pp[1]]
